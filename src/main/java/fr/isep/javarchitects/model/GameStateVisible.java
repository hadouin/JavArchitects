...
public class GameStateVisible {
    ...
    public static final GameStateVisible BASE_STATE = new GameStateVisible(
            Arrays.asList(
                    new PlayerVisible("", WonderFactory.Alexandria.createWonder(), new Card(CardType.CardMaterialGold, CardBack.Alexandrie), new ArrayList<>(), new ArrayList<>(), 0, 0, true),
                    new PlayerVisible("", WonderFactory.Rhodes.createWonder(), new Card(CardType.CardMaterialStone, CardBack.Rhodes), new ArrayList<>(), new ArrayList<>(), 0, 0, false)
            ),
            0,
            Arrays.asList(
